  ...
  return (
    <div className="grid w-screen h-screen grid-cols-12 text-white bg-gradient-to-tl from-blue-950 via-blue-800 to-cyan-400">
      ...
      <div className="grid grid-cols-6 col-span-4 col-start-8 place-content-center">
        <Button onClick={onGoogleSignIn} className="col-span-4 col-start-2 p-0 mb-5 border-blue-300 text-slate-900 bg-slate-100 rounded-xl">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-6 col-span-6 gap-2">
            ...
            {isSignin ? (
              <Button name="login" className="col-span-4 col-start-2 border-blue-300 rounded-xl" type="submit">Login</Button>
            ) : (
              <Button name="signup" className="col-span-4 col-start-2 border-blue-300 rounded-xl" type="submit">Sign Up</Button>
            )}
            <a onClick={handleSignUp} className="col-span-6 underline underline-offset-2 text-slate-300 justify-self-center">
